...
//При смене окна загружаются данные из db => теряется все то,что добавил пользователь,так как нет API,
//позволяющее соединить "сервер" и действия пользователя.
//P.S. go to News.jsx line 23
//
//Решил сделать так,как как это будет более правильная реализация,хоть и одна функция будет утеряна.
